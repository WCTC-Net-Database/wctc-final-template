...
public class GameEngine
{
    ...
    public GameEngine(GameContext context, MenuManager menuManager, OutputManager outputManager, MapManager mapManager, ExplorationUI explorationUI, ILogger<GameEngine> logger)
    {
        _context = context;
